...
# ==========================================
# 1. 환자 사진들이 모여있는 폴더 경로 (시놀로지 내 경로 또는 PC 경로)
TARGET_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), "photo")  # 예: r"/volume1/photo/Patient_Photos"

# 2. 업데이트할 엑셀 파일 경로
EXCEL_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Promotion_Patient_FollowUp_Template.xlsx")
